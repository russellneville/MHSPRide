...
// troopiter.localhost is for local dev testing only — Chrome and macOS both
// resolve any *.localhost hostname to loopback with no /etc/hosts edit
// needed, so visiting http://troopiter.localhost:3000 exercises the
// troopiter skin without touching production DNS or system config.
const TROOPITER_HOSTS = ['troopiter.mhspride.com', 'carpool.troopiter.com', 'troopiter.localhost']
