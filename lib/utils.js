...
// Raised from 60 (issue #199) — canned location names fit comfortably in
// 60, but a full Google-validated street address (the only kind troopiter
// tenants have, having dropped canned locations) routinely runs longer,
// e.g. "27500 East West Leg Road, Government Camp, OR 97028-9709, USA" is
// 61 chars on its own. Keep in sync with firestore.rules' matching
// departure/arrival size() checks on rides and ride_requests.
