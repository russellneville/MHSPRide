...
export const LOCATIONS = [
  ...
  },
  {
    id: "sandy-bi-mart",
    name: "Sandy Bi-Mart",
    address: "37110 US-26, Sandy OR 97055",
    lat: 45.3973,
    lon: -122.2635,
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=45.3973,-122.2635",
    appleMapsUrl: "https://maps.apple.com/?ll=45.3973,-122.2635&q=Sandy%20Bi-Mart",
  },
  {
    id: "gresham-transit",
    name: "Gresham Transit Center",
    address: "140 NW Eastman Pkwy, Gresham OR 97030",
    lat: 45.5024,
    lon: -122.4305,
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=45.5024,-122.4305",
    appleMapsUrl: "https://maps.apple.com/?ll=45.5024,-122.4305&q=Gresham%20Transit%20Center",
  },
  {
    id: "welches-rd",
    name: "Welches Road Park & Ride",
    address: "Welches Rd, Welches OR 97067",
    lat: 45.3513,
    lon: -121.9737,
    googleMapsUrl: "https://www.google.com/maps/search/?api=1&query=45.3513,-121.9737",
    appleMapsUrl: "https://maps.apple.com/?ll=45.3513,-121.9737&q=Welches%20Road",
  },
  {
...
/**
 * Arrival-side destinations (mountain locations).
 * Buzz Bowman and Timberline are also in LOCATIONS above for pickup use.
 */
export const ARRIVAL_LOCATIONS = [
  {
    id: "buzz-bowman",
    name: "Buzz Bowman Ski Patrol Building",
    lat: 45.3048918,
    lon: -121.7590055,
  },
  {
...
/**
 * Resolves any location value to a human-readable display name.
 * Checks LOCATIONS, then ARRIVAL_LOCATIONS, then prettifies the slug as a fallback.
 */
