...
export const RELEASE_NOTES = [
  {
    ...
    date: '2026-08-02',
    highlights: [
      'Add Request a Ride: riders post ride requests, drivers fulfill them',
      'Add ride-request badges and refresh badge artwork',
      'Add app release notes log, linked from FAQ',
      'Auto-format registration phone number as the user types',
      'Fix convoluted calendar location in booking/ride-update emails',
      'Retry arrival-time estimation on failure instead of failing silently',
    ],
  },
  {
    version: 'v0.9.5',
